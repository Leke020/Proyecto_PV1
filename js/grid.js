class Grid {
    constructor(juego, tamanoCelda){
        ...
        for (let i = 0; 
            i < this.cantidadDeCeldasALoAncho + this.cantidadDeCeldasDeMasParaAgregarHaciaDerYAbajo;
            i++){
                this.celdas.push([]);
                for (let j = 0;
                    j < this.cantidadDeCeldasALoAlto + this.cantidadDeCeldasDeMasParaAgregarHaciaDerYAbajo;
                    j++){
